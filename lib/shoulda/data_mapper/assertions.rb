  ...
  module DataMapper # :nodoc:
    module Assertions
      ...
      def assert_bad_value(object_or_klass, attribute, value,
                           error_message_to_expect = self.class.default_error_message(:invalid, attribute))
        object = get_instance_of(object_or_klass)
        object.send("#{attribute}=", value)
      ...
      def assert_object_respond_to(object_or_klass, attribute, error_message=nil)
        object = get_instance_of(object_or_klass)
        assert object.respond_to?(attribute), error_message
      end
      ...
      def instance_variable_name_for(klass)
        Extlib::Inflection.underscore(Extlib::Inflection.demodulize(klass.to_s))
      end
    end
  end
end
